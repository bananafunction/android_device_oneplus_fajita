...
if [[ $# -eq 0 ]]
    ...
    git am "$PATCH_ROOT/0007-PixelPropsUtils-Change-spoof-to-Zenfone-4-to-fix-safetynet.patch"
    git am "$PATCH_ROOT/0008-PixelPropUtils-Make-play-integrity-pass-again.patch"
